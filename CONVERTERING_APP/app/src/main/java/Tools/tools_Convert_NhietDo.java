...
public class tools_Convert_NhietDo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tools__convert__nhiet_do);
        anThanhActionBar();
        addControls();
        addEvents();
    }
    ...
    private void addEvents() {
        ...
        spNhap.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(tools_Convert_NhietDo.this, "Vui lòng chọn đơn vị tiêu chuẩn", Toast.LENGTH_LONG).show();
            }
        });
        ...
        spDoi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(tools_Convert_NhietDo.this, "Vui lòng chọn đơn vị muốn chuyển đổi", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void xacNhanChuyenDoi() {
        ...
        if(str.length()==0) {
            Toast.makeText(tools_Convert_NhietDo.this, "Vui lòng nhập vào số muốn chuyển đổi", Toast.LENGTH_LONG).show();
        }
        else {
            int a= Integer.parseInt(txtChuyenDoi.getText().toString());
    ...
    private void addControls() {
        ...
        arrDistance1=getResources().getStringArray(R.array.temp);
        adapterDistance1=new ArrayAdapter<>(tools_Convert_NhietDo.this, android.R.layout.simple_dropdown_item_1line, arrDistance1);
        spNhap.setAdapter(adapterDistance1);

        //khai báo cho spinner đổi phần tử
        spDoi= this.<Spinner>findViewById(R.id.spDoi2);
        arrDistance2=getResources().getStringArray(R.array.temp);
        adapterDistance2=new ArrayAdapter<>(tools_Convert_NhietDo.this, android.R.layout.simple_dropdown_item_1line, arrDistance2);
