...
public class tools_Convert_KhoiLuong extends AppCompatActivity {
    ...
    double DV[][]={{1         , 0.001  , 0.000001, 0.000000001},
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tools__convert__khoi_luong);
        anThanhActionBar();
        addControls();
        addEvents();
    }

    private void anThanhActionBar() {
    ...
    private void addEvents() {
        ...
        spNhap.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(tools_Convert_KhoiLuong.this, "Vui lòng chọn đơn vị tiêu chuẩn", Toast.LENGTH_LONG).show();
            }
        });
        ...
        spDoi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(tools_Convert_KhoiLuong.this, "Vui lòng chọn đơn vị muốn chuyển đổi", Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void xacNhanChuyenDoi() {
        ...
        if(str.length()==0) {
            Toast.makeText(tools_Convert_KhoiLuong.this, "Vui lòng nhập vào số muốn chuyển đổi", Toast.LENGTH_LONG).show();
        }
        else {
            int a= Integer.parseInt(txtChuyenDoi.getText().toString());
    ...
    private void addControls() {
        ...
        arrDistance1 = getResources().getStringArray(R.array.weight);
        adapterDistance1 = new ArrayAdapter<>(tools_Convert_KhoiLuong.this, android.R.layout.simple_dropdown_item_1line, arrDistance1);
        spNhap.setAdapter(adapterDistance1);

        //khai báo cho spinner đổi phần tử
        spDoi = this.<Spinner>findViewById(R.id.spDoi2);
        arrDistance2 = getResources().getStringArray(R.array.weight);
        adapterDistance2 = new ArrayAdapter<>(tools_Convert_KhoiLuong.this, android.R.layout.simple_dropdown_item_1line, arrDistance2);
